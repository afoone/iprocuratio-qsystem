Astra Linux Common Edition Версия 1.10 релиза "Орел"
1. install Java Oracle 1.7(6, 7, 8) via apt-get
...
--Если команда echo.. не выполняется, просто пропишите репозиторий в менеджере пакетов 
--Если не выполняется, то выполняйте команды от суперпользователя sudo...
...
Java(TM) SE Runtime Environment (build 1.8.0_60-b18)

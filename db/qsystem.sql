...
CREATE INDEX `idx_spec_schedule_calendar` ON `qsystem`.`spec_schedule` (`calendar_id` ASC)  COMMENT '';

CREATE INDEX `idx_spec_schedule_schedule` ON `qsystem`.`spec_schedule` (`schedule_id` ASC)  COMMENT '';
